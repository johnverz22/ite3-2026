...
*   **2.1 The Router Class:** Mapping URLs and HTTP Methods to Controller actions. ✅
...
## Phase 3: The Data Layer (The "Model") (In Progress 🏗️)
*   **3.1 Database Wrapper:** Creating a secure PDO connection class. ✅
*   **3.2 Schema Design:** Designing the users, posts, and categories tables in MySQL. (In Progress - `posts` table created) 🏗️
*   **3.3 The Model Class:** Building the "Librarian" that fetches and saves data using Prepared Statements. ✅

## Phase 4: Features & Security (In Progress 🏗️)
*   **4.1 CRUD Operations:** Building the Admin Dashboard to Create, Read, Update, and Delete blog posts. (Create & Read Implemented) 🏗️
